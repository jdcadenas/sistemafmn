<html>
    ...
    <body >
        <div id="contenedor" >
            ...
            <div align="center" class="Estilo7">     Restauración de Obras</div>
            ...
            Buscar</a> 
              <a href="<?php echo Conectar::ruta() ?>/?accion=repMovimientos&tipo=3" title="Ir a reporte de restauración" >
                <img src="<?php echo Conectar::ruta() ?>/public/images/report_go.png" >
            Ir a reporte de restauración</a>
            <hr>
            <?php
            if (isset($_GET["m"])) {
                switch ($_GET["m"]) {
                    ...
                    case '2':
                        ?>
                        <h5 style="color: red;">No puede enviar a restauración la obra</h5>
                        <?php
                        break;
                    case '3':
                        ?>
            ...
            <div id ="tabla1">
                <form action="" method="post" name="form_o">
                    ...
                    <div align="center">
                        ...
                        <input class="Estilo1" type="submit" name="grabar_rest" value="aceptar">
