...
class Usuarios extends Conectar {
    ...
    public function get_Usuarios_por_id() {
        ...
        $sql = sprintf(
                "select
            u.id_usuario,u.ci_usu,u.nom_usu,u.ape_usu,u.tip_usu,u.dep_usu,u.cargo_usu,
            l.login,l.id_login ,l.contrasena
            from
    ...
    function logueo() {
        ...
        $sql = sprintf
                (
                "select 
                    id_login,login,contrasena 
                from
                    login where login=%s and contrasena=%s", 
                    parent::comillas_inteligentes($_POST["usuario"]), 
                    parent::comillas_inteligentes($_POST["passwd"])
        );
    ...
    public function agregar_usuario() {
        ...
        if (
            empty($_POST["ci_usu"]) or empty($_POST["nom_usu"]) or 
            empty($_POST["ape_usu"]) or empty($_POST["tip_usu"]) or 
            empty($_POST["dep_usu"]) or empty($_POST["cargo_usu"]) or 
            empty($_POST["login"]) or empty($_POST["contrasena"])) 
        {
        ...
        parent::con();
        $sql = sprintf(
                "select login from login where login=%s", 
        ...
        if (mysql_num_rows($res) == 0) {
            $query = sprintf(
                    ...
                    (null, %s, %s);", 
                    parent::comillas_inteligentes($_POST["login"]), 
                    parent::comillas_inteligentes($_POST["contrasena"])
            );
            ...
            $query1 = sprintf
                ...
                (null, %s, %s, %s, %s,%s,%s,%s);", 
                parent::comillas_inteligentes($id_login), 
                parent::comillas_inteligentes($_POST["ci_usu"]), 
                parent::comillas_inteligentes($_POST["nom_usu"]), 
                parent::comillas_inteligentes($_POST["ape_usu"]), 
                parent::comillas_inteligentes($_POST["tip_usu"]), 
                parent::comillas_inteligentes($_POST["dep_usu"]), 
                parent::comillas_inteligentes($_POST["cargo_usu"])
            );
    ...
    public function modificar_usuario() {
        ...
        if (empty($_POST["ci_usu"]) or empty($_POST["nom_usu"]) or 
            empty($_POST["ape_usu"]) or empty($_POST["tip_usu"]) or 
            empty($_POST["dep_usu"]) or empty($_POST["cargo_usu"]) or 
            empty($_POST["login"])) 
        {
            header("Location: " . Conectar::ruta() . 
                "/?accion=modificarUsuario&m=1&v=" . 
                $_POST["id_usuario"]);
            exit();
        }
        parent::con();
        ...
        $sql = sprintf(
                "update login 
                    ...
                    parent::comillas_inteligentes($_POST["login"]), 
                    parent::comillas_inteligentes($_POST["contrasena"]), 
                    parent::comillas_inteligentes($_POST["id_login"])
        );
        mysql_query($sql);
        ...
        header("Location: " . Conectar::ruta() . "/?accion=modificarUsuario&m=3&v=" . 
            $_POST["id_usuario"]);
        exit();
    }
    ...
    public function eliminarUsuario() {
        ...
        $sql = sprintf("delete from login where id_login=%s", 
            parent::comillas_inteligentes($_GET["v"]));

        $res = mysql_query($sql);


        $sql1 = sprintf("delete from usuarios where id_usuario=%s", 
            parent::comillas_inteligentes($_GET["v"]));
